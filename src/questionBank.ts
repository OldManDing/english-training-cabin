...
const GRAMMAR_STRUCTURE_TARGET_COUNT = 1000;
...
const CET4_CORE_GRAMMAR_STRUCTURE_ROWS = [
  ...
  ['grammar-which', '语法结构 6', 'The report ___ we discussed in class yesterday was based on survey data.', 'who', 'which', 'where', 'whose', 'B', '先行词 report 是物，定语从句中作宾语，用 which。', '定语从句|关系代词'],
  ...
  ['grammar-should-be-kept', '语法结构 10', 'Personal learning data should ___ safely.', 'keep', 'kept', 'be kept', 'keeping', 'C', 'data 与 keep 是被动关系，should 后接 be done。', '情态动词被动语态|should be done'],
...
const GRAMMAR_STRUCTURE_CONTEXTS: readonly GrammarStructureContext[] = [
  ...
  },
  {
    ...
    learners: 'Health volunteers',
    learner: 'a health volunteer',
    coach: 'the school nurse',
    skill: 'health communication',
    event: 'the health-awareness activity',
    resource: 'health notice',
    organizer: 'the medical office',
    reason: 'the flu warning',
    pluralMistakes: 'health-advice mistakes',
    artifact: 'health poster',
    actionObject: 'the safety advice',
    actionVerb: 'remember',
    habit: 'checking health notices',
    futureEvent: 'the health talk',
    topic: 'public health',
  },
  {
    slug: 'environment-campaign',
    learners: 'Campaign members',
    learner: 'a campaign member',
    coach: 'the environment teacher',
    skill: 'public explanation',
    event: 'the recycling campaign',
    resource: 'campaign leaflet',
    organizer: 'the green club',
    reason: 'the waste problem',
    pluralMistakes: 'classification mistakes',
    artifact: 'campaign report',
    actionObject: 'the recycling steps',
    actionVerb: 'explain',
    habit: 'sorting examples by category',
    futureEvent: 'the recycling fair',
    topic: 'environmental protection',
  },
  {
    slug: 'technology-workshop',
    learners: 'Workshop users',
    learner: 'a workshop user',
    coach: 'the technology trainer',
    skill: 'digital problem solving',
    event: 'the technology workshop',
    resource: 'operation guide',
    organizer: 'the computer lab',
    reason: 'the software update',
    pluralMistakes: 'operation mistakes',
    artifact: 'user guide',
    actionObject: 'the login steps',
    actionVerb: 'follow',
    habit: 'checking screen prompts',
    futureEvent: 'the software test',
    topic: 'digital skills',
  },
  {
    slug: 'community-service',
    learners: 'Service volunteers',
    learner: 'a service volunteer',
    coach: 'the volunteer coordinator',
    skill: 'service planning',
    event: 'the community-service briefing',
    resource: 'service schedule',
    organizer: 'the neighborhood office',
    reason: 'the traffic restriction',
    pluralMistakes: 'service-record mistakes',
    artifact: 'service log',
    actionObject: 'the visitor list',
    actionVerb: 'check',
    habit: 'confirming each task',
    futureEvent: 'the weekend service',
    topic: 'community support',
  },
  {
    slug: 'sports-training',
    learners: 'Team players',
    learner: 'a team player',
    coach: 'the sports coach',
    skill: 'training discipline',
    event: 'the sports training',
    resource: 'training plan',
    organizer: 'the sports office',
    reason: 'the storm warning',
    pluralMistakes: 'training-record mistakes',
    artifact: 'training note',
    actionObject: 'the warm-up routine',
    actionVerb: 'practice',
    habit: 'recording running time',
    futureEvent: 'the fitness test',
    topic: 'physical education',
  },
  {
    slug: 'museum-visit',
    learners: 'Museum visitors',
    learner: 'a museum visitor',
    coach: 'the history guide',
    skill: 'culture-note taking',
    event: 'the museum visit',
    resource: 'exhibition map',
    organizer: 'the history museum',
    reason: 'the route change',
    pluralMistakes: 'note-taking mistakes',
    artifact: 'visit journal',
    actionObject: 'the exhibition clues',
    actionVerb: 'record',
    habit: 'matching pictures with notes',
    futureEvent: 'the culture report',
    topic: 'local history',
  },
  {
    slug: 'finance-lesson',
    learners: 'Finance learners',
    learner: 'a finance learner',
    coach: 'the finance teacher',
    skill: 'budget explanation',
    event: 'the finance lesson',
    resource: 'budget worksheet',
    organizer: 'the business club',
    reason: 'the price change',
    pluralMistakes: 'calculation mistakes',
    artifact: 'budget plan',
    actionObject: 'the spending record',
    actionVerb: 'calculate',
    habit: 'checking weekly expenses',
    futureEvent: 'the budget quiz',
    topic: 'personal finance',
  },
  {
    slug: 'volunteer-program',
    learners: 'Program volunteers',
    learner: 'a program volunteer',
    coach: 'the program mentor',
    skill: 'task coordination',
    event: 'the volunteer-program meeting',
    resource: 'volunteer handbook',
    organizer: 'the youth center',
    reason: 'the holiday schedule',
    pluralMistakes: 'coordination mistakes',
    artifact: 'task list',
    actionObject: 'the duty chart',
    actionVerb: 'confirm',
    habit: 'checking duty changes',
    futureEvent: 'the volunteer day',
    topic: 'youth service',
  },
  {
    slug: 'travel-planning',
    learners: 'Travel planners',
    learner: 'a travel planner',
    coach: 'the tour adviser',
    skill: 'route comparison',
    event: 'the travel-planning session',
    resource: 'route map',
    organizer: 'the student travel club',
    reason: 'the train delay',
    pluralMistakes: 'route mistakes',
    artifact: 'travel plan',
    actionObject: 'the ticket details',
    actionVerb: 'compare',
    habit: 'checking departure times',
    futureEvent: 'the field trip',
    topic: 'travel arrangements',
  },
  {
    slug: 'workplace-training',
    learners: 'New employees',
    learner: 'a new employee',
    coach: 'the workplace trainer',
    skill: 'professional communication',
    event: 'the workplace training',
    resource: 'training manual',
    organizer: 'the human-resources office',
    reason: 'the policy update',
    pluralMistakes: 'procedure mistakes',
    artifact: 'training record',
    actionObject: 'the service procedure',
    actionVerb: 'learn',
    habit: 'reviewing work examples',
    futureEvent: 'the probation review',
    topic: 'workplace rules',
  },
  {
    slug: 'public-safety',
    learners: 'Safety monitors',
    learner: 'a safety monitor',
    coach: 'the safety officer',
    skill: 'emergency response',
    event: 'the safety drill',
    resource: 'emergency card',
    organizer: 'the security office',
    reason: 'the fire alarm',
    pluralMistakes: 'safety mistakes',
    artifact: 'drill report',
    actionObject: 'the exit route',
    actionVerb: 'remember',
    habit: 'checking safety signs',
    futureEvent: 'the safety inspection',
    topic: 'public safety',
  },
  {
    slug: 'housing-discussion',
    learners: 'Dorm residents',
    learner: 'a dorm resident',
    coach: 'the housing adviser',
    skill: 'problem negotiation',
    event: 'the housing discussion',
    resource: 'dorm rule sheet',
    organizer: 'the housing office',
    reason: 'the noise complaint',
    pluralMistakes: 'agreement mistakes',
    artifact: 'meeting record',
    actionObject: 'the quiet-hour rule',
    actionVerb: 'discuss',
    habit: 'checking shared rules',
    futureEvent: 'the dorm meeting',
    topic: 'campus housing',
  },
  {
    slug: 'media-literacy',
    learners: 'Media learners',
    learner: 'a media learner',
    coach: 'the media teacher',
    skill: 'source checking',
    event: 'the media-literacy class',
    resource: 'fact-checking guide',
    organizer: 'the media center',
    reason: 'the false report',
    pluralMistakes: 'source-checking mistakes',
    artifact: 'fact-check note',
    actionObject: 'the news source',
    actionVerb: 'verify',
    habit: 'checking publication dates',
    futureEvent: 'the media quiz',
    topic: 'online information',
  },
  {
    slug: 'food-culture',
    learners: 'Food-culture readers',
    learner: 'a food-culture reader',
    coach: 'the culture guide',
    skill: 'detail comparison',
    event: 'the food-culture lesson',
    resource: 'menu article',
    organizer: 'the culture center',
    reason: 'the festival event',
    pluralMistakes: 'detail-comparison mistakes',
    artifact: 'culture note',
    actionObject: 'the menu details',
    actionVerb: 'compare',
    habit: 'marking cultural details',
    futureEvent: 'the culture quiz',
    topic: 'food culture',
  },
  {
    slug: 'family-communication',
    learners: 'Family speakers',
    learner: 'a family speaker',
    coach: 'the communication teacher',
    skill: 'polite disagreement',
    event: 'the family-communication class',
    resource: 'dialogue card',
    organizer: 'the counseling center',
    reason: 'a family schedule conflict',
    pluralMistakes: 'dialogue mistakes',
    artifact: 'dialogue script',
    actionObject: 'the polite reply',
    actionVerb: 'practice',
    habit: 'rewriting direct sentences',
    futureEvent: 'the role-play task',
    topic: 'family communication',
  },
  {
    slug: 'transport-survey',
    learners: 'Transport researchers',
    learner: 'a transport researcher',
    coach: 'the transport adviser',
    skill: 'survey-data reading',
    event: 'the transport survey',
    resource: 'transport chart',
    organizer: 'the city research group',
    reason: 'the bus-route change',
    pluralMistakes: 'chart-reading mistakes',
    artifact: 'transport report',
    actionObject: 'the route data',
    actionVerb: 'analyze',
    habit: 'checking chart labels',
    futureEvent: 'the transport presentation',
    topic: 'urban transport',
  },
  {
    slug: 'clinic-appointment',
    learners: 'Clinic visitors',
    learner: 'a clinic visitor',
    coach: 'the nurse',
    skill: 'appointment communication',
    event: 'the clinic visit',
    resource: 'appointment notice',
    organizer: 'the health center',
    reason: 'the doctor’s emergency call',
    pluralMistakes: 'appointment mistakes',
    artifact: 'medical form',
    actionObject: 'the health instructions',
    actionVerb: 'follow',
    habit: 'checking appointment messages',
    futureEvent: 'the follow-up call',
    topic: 'health services',
  },
  {
    slug: 'scholarship-application',
    learners: 'Scholarship applicants',
    learner: 'an applicant',
    coach: 'the scholarship adviser',
    skill: 'formal application writing',
    event: 'the scholarship briefing',
    resource: 'application guide',
    organizer: 'the student-aid office',
    reason: 'the missing transcript',
    pluralMistakes: 'application mistakes',
    artifact: 'personal statement',
    actionObject: 'the recommendation letter',
    actionVerb: 'revise',
    habit: 'checking document requirements',
    futureEvent: 'the application deadline',
    topic: 'scholarship support',
  },
  {
    slug: 'apartment-repair',
    learners: 'Apartment residents',
    learner: 'a resident',
    coach: 'the building manager',
    skill: 'problem reporting',
    event: 'the repair discussion',
    resource: 'repair request form',
    organizer: 'the property office',
    reason: 'the water leak',
    pluralMistakes: 'repair-report mistakes',
    artifact: 'repair note',
    actionObject: 'the damaged pipe',
    actionVerb: 'report',
    habit: 'taking photos of problems',
    futureEvent: 'the repair inspection',
    topic: 'housing maintenance',
  },
  {
    slug: 'online-privacy',
    learners: 'Platform users',
    learner: 'a platform user',
    coach: 'the privacy trainer',
    skill: 'data protection',
    event: 'the privacy workshop',
    resource: 'privacy checklist',
    organizer: 'the IT office',
    reason: 'a data-risk warning',
    pluralMistakes: 'privacy mistakes',
    artifact: 'account record',
    actionObject: 'the password settings',
    actionVerb: 'update',
    habit: 'changing passwords regularly',
    futureEvent: 'the security review',
    topic: 'online privacy',
  },
  {
    slug: 'product-repair',
    learners: 'Customer-service trainees',
    learner: 'a trainee',
    coach: 'the service supervisor',
    skill: 'customer explanation',
    event: 'the repair-service lesson',
    resource: 'warranty card',
    organizer: 'the service desk',
    reason: 'a faulty screen',
    pluralMistakes: 'service-process mistakes',
    artifact: 'repair receipt',
    actionObject: 'the warranty details',
    actionVerb: 'confirm',
    habit: 'checking order numbers',
    futureEvent: 'the customer call',
    topic: 'consumer service',
  },
  {
    slug: 'weather-alert',
    learners: 'Event volunteers',
    learner: 'an event volunteer',
    coach: 'the safety coordinator',
    skill: 'weather-warning response',
    event: 'the outdoor activity',
    resource: 'weather alert',
    organizer: 'the event office',
    reason: 'the strong wind',
    pluralMistakes: 'weather-warning mistakes',
    artifact: 'safety notice',
    actionObject: 'the emergency plan',
    actionVerb: 'check',
    habit: 'reading weather updates',
    futureEvent: 'the outdoor fair',
    topic: 'weather safety',
  },
  {
    slug: 'part-time-job',
    learners: 'Part-time workers',
    learner: 'a part-time worker',
    coach: 'the shift manager',
    skill: 'workplace scheduling',
    event: 'the shift meeting',
    resource: 'work schedule',
    organizer: 'the store office',
    reason: 'the holiday rush',
    pluralMistakes: 'shift-record mistakes',
    artifact: 'shift record',
    actionObject: 'the weekly timetable',
    actionVerb: 'confirm',
    habit: 'checking shift messages',
    futureEvent: 'the weekend shift',
    topic: 'part-time work',
  },
  {
    slug: 'science-fair',
    learners: 'Science-fair teams',
    learner: 'a science-fair participant',
    coach: 'the project mentor',
    skill: 'experiment explanation',
    event: 'the science fair',
    resource: 'experiment poster',
    organizer: 'the science department',
    reason: 'missing lab materials',
    pluralMistakes: 'experiment-description mistakes',
    artifact: 'project poster',
    actionObject: 'the test result',
    actionVerb: 'present',
    habit: 'checking experiment records',
    futureEvent: 'the judging session',
    topic: 'science communication',
  },
  {
    slug: 'art-exhibition',
    learners: 'Art-club members',
    learner: 'an art-club member',
    coach: 'the exhibition curator',
    skill: 'visual description',
    event: 'the art exhibition',
    resource: 'exhibition catalogue',
    organizer: 'the art museum',
    reason: 'the lighting problem',
    pluralMistakes: 'description mistakes',
    artifact: 'exhibition review',
    actionObject: 'the painting details',
    actionVerb: 'describe',
    habit: 'noting colors and shapes',
    futureEvent: 'the gallery talk',
    topic: 'art appreciation',
  },
  {
    slug: 'cafe-order',
    learners: 'Cafe trainees',
    learner: 'a cafe trainee',
    coach: 'the cafe manager',
    skill: 'order confirmation',
    event: 'the cafe training',
    resource: 'order form',
    organizer: 'the training store',
    reason: 'a busy lunch hour',
    pluralMistakes: 'order mistakes',
    artifact: 'order slip',
    actionObject: 'the customer request',
    actionVerb: 'repeat',
    habit: 'checking special requests',
    futureEvent: 'the lunch shift',
    topic: 'service communication',
  },
  {
    slug: 'remote-work',
    learners: 'Remote interns',
    learner: 'a remote intern',
    coach: 'the team mentor',
    skill: 'online teamwork',
    event: 'the remote meeting',
    resource: 'shared document',
    organizer: 'the project team',
    reason: 'the video-call failure',
    pluralMistakes: 'remote-work mistakes',
    artifact: 'team update',
    actionObject: 'the shared file',
    actionVerb: 'upload',
    habit: 'summarizing online tasks',
    futureEvent: 'the progress review',
    topic: 'remote collaboration',
  },
  {
    slug: 'historical-tour',
    learners: 'Tour guides',
    learner: 'a tour guide',
    coach: 'the history lecturer',
    skill: 'historical explanation',
    event: 'the historical tour',
    resource: 'tour script',
    organizer: 'the heritage office',
    reason: 'the route closure',
    pluralMistakes: 'tour-commentary mistakes',
    artifact: 'tour plan',
    actionObject: 'the historical facts',
    actionVerb: 'explain',
    habit: 'checking dates and names',
    futureEvent: 'the visitor tour',
    topic: 'local heritage',
  },
];

const BASE_GRAMMAR_STRUCTURE_FRAMES: readonly GrammarStructureFrame[] = [
  {
  ...
  },
  {
    ...
    prompt: (context) => `The explanation in the ${context.artifact} is ___ clear nor complete.`,
  ...
  {
    slug: 'modal-passive',
    focus: '情态动词被动语态|should be done',
    prompt: (context) => `The ${context.artifact} should ___ safely after ${context.event}.`,
  ...
  },
  {
    ...
    focus: '状语从句|so that',
    prompt: (context) => `The instructions for ${context.event} were written clearly ___ everyone could follow them.`,
  ...
  },
  {
    ...
    prompt: (context) => `The group looks forward to ___ in ${context.event}.`,
  ...
  },
  {
    ...
    prompt: (context) => `It is essential that ${context.learner} ___ the instructions carefully before ${context.futureEvent}.`,
    options: { A: 'reads', B: 'read', C: 'reading', D: 'to read' },
    answer: 'B',
    explanation: 'essential 后的 that 从句可用“should + 动词原形”，should 可省略。',
  },
  {
    slug: 'simple-past-yesterday',
    focus: '时态|一般过去时',
    prompt: (context) => `${capitalizeFirst(context.coach)} ___ the deadline during ${context.event} yesterday.`,
    options: { A: 'announces', B: 'announced', C: 'has announced', D: 'will announce' },
    answer: 'B',
    explanation: 'yesterday 明确指过去时间，谓语用一般过去时。',
  },
  {
    slug: 'present-continuous-now',
    focus: '时态|现在进行时',
    prompt: (context) => `${capitalizeFirst(context.organizer)} ___ the details now, so ${lowerFirst(context.learners)} should wait.`,
    options: { A: 'checks', B: 'is checking', C: 'checked', D: 'has checked' },
    answer: 'B',
    explanation: 'now 表示动作正在进行，用现在进行时 is checking。',
  },
  {
    slug: 'past-perfect-before',
    focus: '时态|过去完成时',
    prompt: (context) => `By the time ${context.event} began, ${lowerFirst(context.learners)} ___ the instructions for the ${context.resource}.`,
    options: { A: 'had read', B: 'have read', C: 'read', D: 'will read' },
    answer: 'A',
    explanation: 'by the time 后接过去动作时，先发生的动作常用过去完成时。',
  },
  {
    slug: 'future-reminder',
    focus: '时态|一般将来时',
    prompt: (context) => `${capitalizeFirst(context.organizer)} ___ a reminder before ${context.futureEvent}.`,
    options: { A: 'sent', B: 'has sent', C: 'will send', D: 'is sent' },
    answer: 'C',
    explanation: 'before 后面的未来安排提示主句动作尚未发生，用 will do。',
  },
  {
    slug: 'present-passive',
    focus: '被动语态|一般现在时',
    prompt: (context) => `The ${context.resource} ___ by ${context.organizer} before ${context.futureEvent}.`,
    options: { A: 'checks', B: 'is checked', C: 'checked', D: 'has checking' },
    answer: 'B',
    explanation: 'resource 与 check 是被动关系，常规流程用一般现在时被动。',
  },
  {
    slug: 'must-passive',
    focus: '情态动词被动语态|must be done',
    prompt: (context) => `The ${context.artifact} must ___ before it is shared with the class.`,
    options: { A: 'check', B: 'be checked', C: 'checking', D: 'checked' },
    answer: 'B',
    explanation: 'must 后接被动结构 be done，表示“必须被检查”。',
  },
  {
    slug: 'being-passive',
    focus: '被动语态|现在进行时',
    prompt: (context) => `A new ${context.resource} is being ___ for ${context.event}.`,
    options: { A: 'prepare', B: 'prepared', C: 'preparing', D: 'prepares' },
    answer: 'B',
    explanation: 'is being done 表示“正在被……”，prepared 是过去分词。',
  },
  {
    slug: 'avoid-doing',
    focus: '非谓语|avoid doing',
    prompt: (context) => `${context.learners} avoid ___ the same mistake by checking notes first.`,
    options: { A: 'repeat', B: 'to repeat', C: 'repeating', D: 'repeated' },
    answer: 'C',
    explanation: 'avoid 后接动名词 doing。',
  },
  {
    slug: 'difficulty-doing',
    focus: '非谓语|have difficulty doing',
    prompt: (context) => `${capitalizeFirst(context.learner)} had difficulty ___ ${context.actionObject} after class.`,
    options: { A: 'understanding', B: 'understand', C: 'to understand', D: 'understood' },
    answer: 'A',
    explanation: 'have difficulty doing sth. 表示“做某事有困难”。',
  },
  {
    slug: 'make-object-base',
    focus: '非谓语|make sb do',
    prompt: (context) => `The short deadline made ${lowerFirst(context.learners)} ___ the answer quickly.`,
    options: { A: 'check', B: 'to check', C: 'checking', D: 'checked' },
    answer: 'A',
    explanation: 'make sb. do sth. 中宾补用动词原形。',
  },
  {
    slug: 'spend-time-doing',
    focus: '非谓语|spend time doing',
    prompt: (context) => `${capitalizeFirst(context.learner)} spent ten minutes ___ ${context.actionObject}.`,
    options: { A: 'review', B: 'to review', C: 'reviewing', D: 'reviewed' },
    answer: 'C',
    explanation: 'spend time doing sth. 表示“花时间做某事”。',
  },
  {
    slug: 'although-clause',
    focus: '状语从句|although',
    prompt: (context) => `___ ${context.event} was short, it gave ${lowerFirst(context.learners)} useful practice.`,
    options: { A: 'Although', B: 'Because of', C: 'Despite', D: 'So that' },
    answer: 'A',
    explanation: 'although 后接完整从句，表示让步关系。',
  },
  {
    slug: 'relative-where',
    focus: '定语从句|关系副词',
    prompt: (context) => `The room ___ ${context.event} was held was too small.`,
    options: { A: 'which', B: 'where', C: 'who', D: 'what' },
    answer: 'B',
    explanation: '先行词是地点，关系词在从句中作地点状语，用 where。',
  },
  {
    slug: 'noun-clause-what',
    focus: '名词性从句|what',
    prompt: (context) => `The report explains ___ ${lowerFirst(context.learners)} should do next.`,
    options: { A: 'what', B: 'which', C: 'that', D: 'where' },
    answer: 'A',
    explanation: 'what 引导宾语从句，并在从句中作 do 的宾语。',
  },
  {
    slug: 'before-connector',
    focus: '时间状语从句|before',
    prompt: (context) => `Please check the ${context.resource} ___ you submit it after ${context.event}.`,
    options: { A: 'before', B: 'because of', C: 'despite', D: 'unless of' },
    answer: 'A',
    explanation: 'before 引导时间状语从句，表示提交前先检查。',
  },
  {
    slug: 'each-singular',
    focus: '主谓一致|each',
    prompt: (context) => `Each of the ${context.pluralMistakes} ___ discussed after class.`,
    options: { A: 'was', B: 'were', C: 'are', D: 'have' },
    answer: 'A',
    explanation: 'each of 后接复数名词时，谓语通常用单数。',
  },
  {
    slug: 'number-of-singular',
    focus: '主谓一致|the number of',
    prompt: (context) => `The number of ${context.pluralMistakes} ___ fallen since last month.`,
    options: { A: 'has', B: 'have', C: 'are', D: 'were' },
    answer: 'A',
    explanation: 'the number of 作主语时，谓语用单数。',
  },
  {
    slug: 'a-number-of-plural',
    focus: '主谓一致|a number of',
    prompt: (context) => `A number of ${lowerFirst(context.learners)} ___ joined the review group.`,
    options: { A: 'has', B: 'have', C: 'is', D: 'was' },
    answer: 'B',
    explanation: 'a number of 后接复数名词，谓语用复数。',
  },
  {
    slug: 'prefer-doing-to-doing',
    focus: '固定结构|prefer doing to doing',
    prompt: (context) => `${context.learners} prefer ___ examples about ${context.topic} to memorizing isolated rules.`,
    options: { A: 'using', B: 'use', C: 'to use', D: 'used' },
    answer: 'A',
    explanation: 'prefer doing to doing 表示“比起……更喜欢……”。',
  },
  {
    slug: 'devote-to-doing',
    focus: '固定搭配|devote to doing',
    prompt: (context) => `${capitalizeFirst(context.learner)} devoted an hour to ___ ${context.actionObject}.`,
    options: { A: 'review', B: 'reviewing', C: 'to review', D: 'reviewed' },
    answer: 'B',
    explanation: 'devote time to doing sth. 中 to 是介词，后接动名词。',
  },
  {
    slug: 'no-point-doing',
    focus: '固定结构|no point in doing',
    prompt: (context) => `There is no point in ___ answers during ${context.event} without checking the passage.`,
    options: { A: 'guess', B: 'to guess', C: 'guessing', D: 'guessed' },
    answer: 'C',
    explanation: 'There is no point in doing sth. 表示“做某事没有意义”。',
  },
  {
    slug: 'as-as-comparison',
    focus: '比较结构|as...as',
    prompt: (context) => `The ${context.artifact} is as ___ as the sample answer after revision.`,
    options: { A: 'clear', B: 'clearly', C: 'clearer', D: 'clearest' },
    answer: 'A',
    explanation: 'as...as 中间用形容词或副词原级；draft 作主语需形容词 clear。',
  },
  {
    slug: 'too-to',
    focus: '比较结构|too...to',
    prompt: (context) => `The sentence in the ${context.artifact} was too long ___ in one breath.`,
    options: { A: 'read', B: 'to read', C: 'reading', D: 'readed' },
    answer: 'B',
    explanation: 'too + 形容词 + to do 表示“太……而不能……”。',
  },
  {
    slug: 'enough-to',
    focus: '比较结构|enough to',
    prompt: (context) => `${capitalizeFirst(context.learner)} was careful enough ___ the hidden clue.`,
    options: { A: 'notice', B: 'to notice', C: 'noticing', D: 'noticed' },
    answer: 'B',
    explanation: '形容词 + enough + to do 表示“足够……去做”。',
  },
  {
    slug: 'only-after-did',
    focus: '倒装结构|only after',
    prompt: (context) => `Only after ${context.event} ___ ${lowerFirst(context.learners)} understand the rule.`,
    options: { A: 'did', B: 'do', C: 'had', D: 'will' },
    answer: 'A',
    explanation: 'only after 置于句首时，主句用部分倒装；过去语境下用 did。',
  },
  {
    slug: 'rarely-do',
    focus: '倒装结构|rarely',
    prompt: (context) => `Rarely ___ ${lowerFirst(context.learners)} miss the topic sentence after this drill.`,
    options: { A: 'do', B: 'does', C: 'are', D: 'have' },
    answer: 'A',
    explanation: 'rarely 位于句首时，主句用部分倒装；复数主语用 do。',
  },
  {
    slug: 'if-were',
    focus: '虚拟语气|if 从句',
    prompt: (context) => `If ${context.learner} ___ more confident, the presentation would sound smoother.`,
    options: { A: 'is', B: 'was', C: 'were', D: 'has been' },
    answer: 'C',
    explanation: '与现在事实相反的虚拟条件句中，be 动词常用 were。',
  },
  {
    slug: 'suggest-that-base',
    focus: '虚拟语气|that从句动词原形',
    prompt: (context) => `The teacher suggested that ${context.learner} ___ the answer again.`,
    options: { A: 'check', B: 'checks', C: 'checking', D: 'checked' },
    answer: 'A',
    explanation: 'suggest 表示建议时，that 从句可用 should do，should 可省略。',
  },
  {
    slug: 'article-specific-the',
    focus: '冠词|特指用the',
    prompt: (context) => `${capitalizeFirst(context.learner)} returned to ___ room where ${context.event} had been held.`,
    options: { A: 'a', B: 'an', C: 'the', D: '/' },
    answer: 'C',
    explanation: '后面有定语从句限定 room，表示特指，用 the。',
  },
  {
    slug: 'article-profession-a',
    focus: '冠词|职业身份用a',
    prompt: (context) => `${capitalizeFirst(context.coach)} is ___ helpful adviser for ${lowerFirst(context.learners)}.`,
    options: { A: 'a', B: 'an', C: 'the', D: '/' },
    answer: 'A',
    explanation: '可数名词单数 adviser 表示一种身份，前面用不定冠词 a。',
  },
  {
    slug: 'pronoun-reflexive',
    focus: '代词|反身代词',
    prompt: (context) => `${context.learners} checked the answers by ___ before asking ${context.coach}.`,
    options: { A: 'them', B: 'theirs', C: 'themselves', D: 'their' },
    answer: 'C',
    explanation: 'by oneself 表示“独自、靠自己”，复数主语用 themselves。',
  },
  {
    slug: 'pronoun-each-other',
    focus: '代词|相互代词',
    prompt: (context) => `During ${context.event}, ${lowerFirst(context.learners)} corrected ___ mistakes politely.`,
    options: { A: 'each other’s', B: 'themselves', C: 'one', D: 'another' },
    answer: 'A',
    explanation: '表示“彼此的错误”用 each other’s mistakes。',
  },
  {
    slug: 'preposition-good-at',
    focus: '介词搭配|be good at',
    prompt: (context) => `${capitalizeFirst(context.learner)} is good ___ finding clues about ${context.topic}.`,
    options: { A: 'in', B: 'at', C: 'for', D: 'with' },
    answer: 'B',
    explanation: 'be good at doing sth. 表示“擅长做某事”。',
  },
  {
    slug: 'preposition-responsible-for',
    focus: '介词搭配|be responsible for',
    prompt: (context) => `${capitalizeFirst(context.organizer)} is responsible ___ the final ${context.artifact}.`,
    options: { A: 'to', B: 'with', C: 'for', D: 'about' },
    answer: 'C',
    explanation: 'be responsible for 表示“对……负责”。',
  },
  {
    slug: 'adjective-interested-in',
    focus: '形容词搭配|interested in',
    prompt: (context) => `More ${lowerFirst(context.learners)} became interested ___ ${context.topic} after ${context.event}.`,
    options: { A: 'in', B: 'on', C: 'at', D: 'for' },
    answer: 'A',
    explanation: 'be interested in 表示“对……感兴趣”。',
  },
  {
    slug: 'adjective-different-from',
    focus: '形容词搭配|different from',
    prompt: (context) => `The final ${context.artifact} was different ___ the first version.`,
    options: { A: 'with', B: 'as', C: 'from', D: 'to' },
    answer: 'C',
    explanation: 'different from 是常用搭配，表示“不同于”。',
  },
  {
    slug: 'adverb-enough-after-adjective',
    focus: '副词位置|形容词后enough',
    prompt: (context) => `The instruction was clear ___ for ${lowerFirst(context.learners)} to follow.`,
    options: { A: 'enough', B: 'enoughly', C: 'too', D: 'very enough' },
    answer: 'A',
    explanation: 'enough 修饰形容词时放在形容词后面。',
  },
  {
    slug: 'so-adjective-that',
    focus: '结果状语|so...that',
    prompt: (context) => `The ${context.resource} was ___ clear that ${lowerFirst(context.learners)} finished quickly.`,
    options: { A: 'such', B: 'so', C: 'too', D: 'enough' },
    answer: 'B',
    explanation: 'so + 形容词 + that 从句表示“如此……以至于”。',
  },
  {
    slug: 'too-much-uncountable',
    focus: '数量词|too much不可数',
    prompt: (context) => `Too ___ pressure before ${context.futureEvent} may reduce confidence.`,
    options: { A: 'many', B: 'much', C: 'few', D: 'little' },
    answer: 'B',
    explanation: 'pressure 是不可数名词，表示太多压力用 too much。',
  },
  {
    slug: 'many-countable-plural',
    focus: '数量词|many可数复数',
    prompt: (context) => `${capitalizeFirst(context.learners)} found ___ useful examples in the ${context.resource}.`,
    options: { A: 'much', B: 'many', C: 'little', D: 'any much' },
    answer: 'B',
    explanation: 'examples 是可数名词复数，表示许多用 many。',
  },
  {
    slug: 'there-be-singular',
    focus: 'there be|就近单数',
    prompt: (context) => `There ___ a useful example and two notes in the ${context.resource}.`,
    options: { A: 'is', B: 'are', C: 'have', D: 'has' },
    answer: 'A',
    explanation: 'there be 句型遵循就近原则，最近的主语 a useful example 是单数，用 is。',
  },
  {
    slug: 'there-be-plural',
    focus: 'there be|就近复数',
    prompt: (context) => `There ___ two notes and a useful example in the ${context.resource}.`,
    options: { A: 'is', B: 'are', C: 'has', D: 'be' },
    answer: 'B',
    explanation: 'there be 句型就近主语 two notes 是复数，用 are。',
  },
  {
    slug: 'emphatic-it-was-that',
    focus: '强调句|It was...that',
    prompt: (context) => `It was ${context.coach} ___ helped ${lowerFirst(context.learners)} revise the ${context.artifact}.`,
    options: { A: 'which', B: 'where', C: 'that', D: 'what' },
    answer: 'C',
    explanation: '强调句基本结构是 It is/was + 被强调部分 + that/who ...。',
  },
  {
    slug: 'exclamation-what-a',
    focus: '感叹句|what a',
    prompt: (context) => `___ useful ${context.artifact} ${context.learner} wrote after ${context.event}!`,
    options: { A: 'What a', B: 'How', C: 'What', D: 'How a' },
    answer: 'A',
    explanation: '可数名词单数 artifact 前有形容词时，感叹句用 What a + adj. + n.。',
  },
  {
    slug: 'exclamation-how-adjective',
    focus: '感叹句|how形容词',
    prompt: (context) => `___ helpful the ${context.resource} was during ${context.event}!`,
    options: { A: 'What', B: 'How', C: 'What a', D: 'How a' },
    answer: 'B',
    explanation: 'how + 形容词/副词 + 主语 + 谓语构成感叹句。',
  },
  {
    slug: 'not-only-but-also',
    focus: '并列结构|not only...but also',
    prompt: (context) => `The ${context.topic} task improved not only accuracy ___ confidence.`,
    options: { A: 'and', B: 'but also', C: 'or', D: 'nor' },
    answer: 'B',
    explanation: 'not only...but also... 表示“不但……而且……”。',
  },
  {
    slug: 'both-and',
    focus: '并列结构|both...and',
    prompt: (context) => `The ${context.artifact} included both examples ___ explanations.`,
    options: { A: 'and', B: 'or', C: 'nor', D: 'but' },
    answer: 'A',
    explanation: 'both...and... 表示“两者都”。',
  },
  {
    slug: 'either-or-choice',
    focus: '并列结构|either...or选择',
    prompt: (context) => `${capitalizeFirst(context.learner)} can either review ${context.actionObject} ___ ask for help.`,
    options: { A: 'and', B: 'nor', C: 'or', D: 'but also' },
    answer: 'C',
    explanation: 'either...or... 表示“两者择一”。',
  },
  {
    slug: 'as-soon-as',
    focus: '时间状语从句|as soon as',
    prompt: (context) => `${capitalizeFirst(context.learner)} will submit the ${context.artifact} ___ the final check is finished.`,
    options: { A: 'as soon as', B: 'because of', C: 'despite', D: 'instead of' },
    answer: 'A',
    explanation: 'as soon as 引导时间状语从句，表示“一……就……”。',
  },
  {
    slug: 'as-long-as',
    focus: '条件状语从句|as long as',
    prompt: (context) => `${context.learners} can use the ${context.resource} ___ they return it on time.`,
    options: { A: 'as long as', B: 'as if', C: 'even though', D: 'so that' },
    answer: 'A',
    explanation: 'as long as 表示“只要”，引导条件状语从句。',
  },
  {
    slug: 'in-case',
    focus: '目的状语从句|in case',
    prompt: (context) => `${capitalizeFirst(context.learner)} saved the ${context.artifact} twice ___ the computer failed.`,
    options: { A: 'in case', B: 'even if', C: 'as long as', D: 'now that' },
    answer: 'A',
    explanation: 'in case 表示“以防、万一”，引导目的或条件意味的从句。',
  },
  {
    slug: 'now-that',
  ...
  {
    slug: 'no-matter-what',
    focus: '让步状语从句|no matter what',
    prompt: (context) => `${context.learners} should check evidence ___ answer looks attractive.`,
    options: { A: 'no matter what', B: 'because of', C: 'as soon as', D: 'in order to' },
    answer: 'A',
    explanation: 'no matter what 表示“无论什么”，引导让步状语从句。',
  },
  {
    slug: 'not-until-inversion',
    focus: '倒装结构|not until句首',
    prompt: (context) => `Not until ${context.event} ended ___ ${lowerFirst(context.learners)} see the mistake clearly.`,
    options: { A: 'did', B: 'do', C: 'had', D: 'were' },
    answer: 'A',
    explanation: 'not until 位于句首时，主句需要部分倒装。',
  },
  {
    slug: 'so-do-i',
    focus: '倒装结构|so do I',
    prompt: (context) => `${capitalizeFirst(context.learner)} needs more practice, and so ___ the rest of the group.`,
    options: { A: 'do', B: 'does', C: 'is', D: 'has' },
    answer: 'A',
    explanation: 'so + 助动词 + 主语 表示“……也一样”，主语是复数 group members，助动词用 do。',
  },
  {
    slug: 'it-takes-time-to',
    focus: '固定句型|It takes time to do',
    prompt: (context) => `It took ${lowerFirst(context.learners)} ten minutes ___ the ${context.resource}.`,
    options: { A: 'check', B: 'to check', C: 'checking', D: 'checked' },
    answer: 'B',
    explanation: 'It takes/took sb. time to do sth. 表示“某人花时间做某事”。',
  },
  {
    slug: 'find-it-adjective-to',
    focus: '固定句型|find it adj. to do',
    prompt: (context) => `${context.learners} found it useful ___ ${context.actionObject} before ${context.futureEvent}.`,
    options: { A: 'review', B: 'to review', C: 'reviewing', D: 'reviewed' },
    answer: 'B',
    explanation: 'find it + 形容词 + to do sth. 中 it 是形式宾语，真正宾语是不定式。',
  },
  {
    slug: 'keep-object-adjective',
    focus: '宾语补足语|keep sth. adj.',
    prompt: (context) => `Clear labels kept the ${context.resource} ___ during ${context.event}.`,
    options: { A: 'use', B: 'usefully', C: 'useful', D: 'using' },
    answer: 'C',
    explanation: 'keep + 宾语 + 形容词，表示“使……保持某种状态”。',
  },
  {
    slug: 'make-it-possible-to',
    focus: '形式宾语|make it possible to do',
    prompt: (context) => `The new plan made it possible ___ ${context.actionObject} before class.`,
    options: { A: 'review', B: 'to review', C: 'reviewing', D: 'reviewed' },
    answer: 'B',
    explanation: 'make it possible to do sth. 中 it 是形式宾语，to do 是真正宾语。',
  },
  {
    slug: 'be-likely-to',
    focus: '固定结构|be likely to do',
    prompt: (context) => `${capitalizeFirst(context.learner)} is likely ___ the same mistake without review.`,
    options: { A: 'repeat', B: 'to repeat', C: 'repeating', D: 'repeated' },
    answer: 'B',
    explanation: 'be likely to do sth. 表示“很可能做某事”。',
  },
] as const;

const SUPPLEMENTAL_GRAMMAR_STRUCTURE_FRAMES: readonly GrammarStructureFrame[] = [
  {
    slug: 'present-perfect-already',
    focus: '时态|现在完成时',
    prompt: (context) => `${capitalizeFirst(context.learners)} have already ___ the main problem in the ${context.artifact}.`,
    options: { A: 'find', B: 'found', C: 'finding', D: 'finds' },
    answer: 'B',
    explanation: 'have already 后接过去分词，表示动作已经完成。',
  },
  {
    slug: 'present-perfect-yet',
    focus: '时态|现在完成时',
    prompt: (context) => `${capitalizeFirst(context.learner)} has not ___ the ${context.resource} yet.`,
    options: { A: 'receive', B: 'received', C: 'receiving', D: 'receives' },
    answer: 'B',
    explanation: 'has not ... yet 表示“尚未完成”，动词用过去分词。',
  },
  {
    slug: 'present-perfect-continuous',
    focus: '时态|现在完成进行时',
    prompt: (context) => `${capitalizeFirst(context.learners)} ___ ${context.habit} for two weeks.`,
    options: { A: 'practice', B: 'practiced', C: 'have been practicing', D: 'will practice' },
    answer: 'C',
    explanation: 'for two weeks 表示持续到现在的动作，可用现在完成进行时。',
  },
  {
    slug: 'past-continuous-when',
    focus: '时态|过去进行时',
    prompt: (context) => `${capitalizeFirst(context.learner)} ___ the ${context.artifact} when the reminder arrived.`,
    options: { A: 'revised', B: 'was revising', C: 'has revised', D: 'will revise' },
    answer: 'B',
    explanation: 'when 引出的过去时间点发生时，背景动作正在进行，用过去进行时。',
  },
  {
    slug: 'past-perfect-after',
    focus: '时态|过去完成时',
    prompt: (context) => `After ${context.learners} ___ the ${context.resource}, the discussion became easier.`,
    options: { A: 'had read', B: 'read', C: 'have read', D: 'will read' },
    answer: 'A',
    explanation: 'read 发生在过去的 discussion 之前，可用过去完成时。',
  },
  {
    slug: 'future-perfect-by',
    focus: '时态|将来完成时',
    prompt: (context) => `By next Monday, ${context.organizer} ___ the final ${context.artifact}.`,
    options: { A: 'will finish', B: 'will have finished', C: 'finished', D: 'has finished' },
    answer: 'B',
    explanation: 'by next Monday 强调到未来某时已经完成，用将来完成时。',
  },
  {
  ...
  {
    slug: 'past-future-would',
    focus: '时态|过去将来时',
    prompt: (context) => `${capitalizeFirst(context.coach)} said that ${context.learner} ___ the answer later.`,
    options: { A: 'checks', B: 'will check', C: 'would check', D: 'has checked' },
    answer: 'C',
    explanation: '主句 said 是过去时，从句表达过去看来将要发生的动作，用 would do。',
  },
  {
    slug: 'simple-present-routine',
    focus: '时态|一般现在时',
    prompt: (context) => `${capitalizeFirst(context.organizer)} usually ___ the ${context.resource} before ${context.event}.`,
    options: { A: 'checks', B: 'checked', C: 'is checking', D: 'has checked' },
    answer: 'A',
    explanation: 'usually 表示经常性动作，用一般现在时。',
  },
  {
    slug: 'present-perfect-passive',
    focus: '被动语态|现在完成时',
    prompt: (context) => `The ${context.artifact} ___ by ${context.coach} twice this week.`,
    options: { A: 'has checked', B: 'has been checked', C: 'checked', D: 'is checking' },
    answer: 'B',
    explanation: '主语 artifact 承受 check，this week 到现在为止，用现在完成时被动。',
  },
  {
  ...
  },
  {
    slug: 'future-passive',
    focus: '被动语态|一般将来时',
    prompt: (context) => `The final ${context.artifact} ___ to all members tomorrow.`,
    options: { A: 'will send', B: 'will be sent', C: 'sent', D: 'has sent' },
    answer: 'B',
    explanation: 'artifact 是被发送的对象，tomorrow 表示将来，用 will be done。',
  },
  {
    slug: 'have-something-done',
    focus: '被动语态|have sth done',
    prompt: (context) => `${capitalizeFirst(context.learner)} had the ${context.artifact} ___ before the deadline.`,
    options: { A: 'print', B: 'printed', C: 'printing', D: 'to print' },
    answer: 'B',
    explanation: 'have sth. done 表示“让某事被做”，用过去分词。',
  },
  {
    slug: 'need-doing-passive',
    focus: '被动语态|need doing',
    prompt: (context) => `The old ${context.resource} needs ___ before ${context.futureEvent}.`,
    options: { A: 'update', B: 'to update', C: 'updating', D: 'updates' },
    answer: 'C',
    explanation: 'need doing 可表示被动意义，相当于 need to be done。',
  },
  {
    slug: 'remember-to-do',
    focus: '非谓语|remember to do',
    prompt: (context) => `${capitalizeFirst(context.learners)} should remember ___ the ${context.resource} before leaving.`,
    options: { A: 'return', B: 'to return', C: 'returning', D: 'returned' },
    answer: 'B',
    explanation: 'remember to do 表示记得去做还未做的事。',
  },
  {
    slug: 'remember-doing',
    focus: '非谓语|remember doing',
    prompt: (context) => `${capitalizeFirst(context.learner)} remembered ___ the same issue in last week’s ${context.event}.`,
    options: { A: 'discuss', B: 'to discuss', C: 'discussing', D: 'discussed' },
    answer: 'C',
    explanation: 'remember doing 表示记得做过某事。',
  },
  {
    slug: 'stop-to-do',
    focus: '非谓语|stop to do',
    prompt: (context) => `${capitalizeFirst(context.learners)} stopped ___ the notice before entering the office.`,
    options: { A: 'read', B: 'to read', C: 'reading', D: 'readed' },
    answer: 'B',
    explanation: 'stop to do 表示停下来去做另一件事。',
  },
  {
    slug: 'stop-doing',
    focus: '非谓语|stop doing',
    prompt: (context) => `${capitalizeFirst(context.coach)} asked ${lowerFirst(context.learners)} to stop ___ unsupported details.`,
    options: { A: 'add', B: 'to add', C: 'adding', D: 'added' },
    answer: 'C',
    explanation: 'stop doing 表示停止正在做的事。',
  },
  {
    slug: 'allow-sb-to-do',
    focus: '非谓语|allow sb to do',
    prompt: (context) => `The new rule allows ${lowerFirst(context.learners)} ___ the ${context.resource} after class.`,
    options: { A: 'use', B: 'to use', C: 'using', D: 'used' },
    answer: 'B',
    explanation: 'allow sb. to do sth. 中宾补用不定式。',
  },
  {
    slug: 'let-sb-do',
    focus: '非谓语|let sb do',
    prompt: (context) => `${capitalizeFirst(context.coach)} let ${context.learner} ___ the first draft again.`,
    options: { A: 'revise', B: 'to revise', C: 'revising', D: 'revised' },
    answer: 'A',
    explanation: 'let sb. do sth. 中宾补用动词原形。',
  },
  {
    slug: 'see-sb-doing',
    focus: '非谓语|see sb doing',
    prompt: (context) => `${capitalizeFirst(context.coach)} saw ${context.learner} ___ notes during ${context.event}.`,
    options: { A: 'take', B: 'to take', C: 'taking', D: 'taken' },
    answer: 'C',
    explanation: 'see sb. doing sth. 强调看到某人正在做某事。',
  },
  {
    slug: 'remain-to-be-done',
    focus: '非谓语|remain to be done',
    prompt: (context) => `Several problems in the ${context.artifact} remain ___ before ${context.futureEvent}.`,
    options: { A: 'solve', B: 'to solve', C: 'to be solved', D: 'solving' },
    answer: 'C',
    explanation: 'remain to be done 表示“仍有待被……”。',
  },
  {
    slug: 'worth-doing',
    focus: '固定结构|be worth doing',
    prompt: (context) => `The advice in the ${context.resource} is worth ___.`,
    options: { A: 'consider', B: 'to consider', C: 'considering', D: 'considered' },
    answer: 'C',
    explanation: 'be worth doing 是固定结构。',
  },
  {
    slug: 'no-choice-but-to',
    focus: '固定结构|have no choice but to',
    prompt: (context) => `${capitalizeFirst(context.learners)} had no choice but ___ the task again.`,
    options: { A: 'do', B: 'to do', C: 'doing', D: 'done' },
    answer: 'B',
    explanation: 'have no choice but to do 表示“别无选择只好做”。',
  },
  {
    slug: 'cannot-help-doing',
    focus: '固定结构|cannot help doing',
    prompt: (context) => `${capitalizeFirst(context.learner)} could not help ___ when the answer finally made sense.`,
    options: { A: 'smile', B: 'to smile', C: 'smiling', D: 'smiled' },
    answer: 'C',
    explanation: 'cannot help doing 表示“忍不住做某事”。',
  },
  {
    slug: 'would-rather-do',
    focus: '固定结构|would rather do',
    prompt: (context) => `${capitalizeFirst(context.learners)} would rather ___ one rule deeply than rush through ten examples.`,
    options: { A: 'study', B: 'to study', C: 'studying', D: 'studied' },
    answer: 'A',
    explanation: 'would rather 后接动词原形。',
  },
  {
    slug: 'be-supposed-to',
    focus: '固定结构|be supposed to do',
    prompt: (context) => `${capitalizeFirst(context.learners)} are supposed ___ the ${context.artifact} before noon.`,
    options: { A: 'submit', B: 'to submit', C: 'submitting', D: 'submitted' },
    answer: 'B',
    explanation: 'be supposed to do 表示“应该、按规定要做”。',
  },
  {
    slug: 'succeed-in-doing',
    focus: '固定搭配|succeed in doing',
    prompt: (context) => `${capitalizeFirst(context.learner)} succeeded in ___ the difficult sentence.`,
    options: { A: 'explain', B: 'to explain', C: 'explaining', D: 'explained' },
    answer: 'C',
    explanation: 'succeed in doing sth. 表示“成功做成某事”。',
  },
  {
    slug: 'insist-on-doing',
    focus: '固定搭配|insist on doing',
    prompt: (context) => `${capitalizeFirst(context.coach)} insisted on ___ every answer with evidence.`,
    options: { A: 'check', B: 'to check', C: 'checking', D: 'checked' },
    answer: 'C',
    explanation: 'insist on doing sth. 中 on 是介词，后接动名词。',
  },
  {
    slug: 'whether-object-clause',
    focus: '名词性从句|whether',
    prompt: (context) => `${capitalizeFirst(context.learners)} discussed ___ the ${context.resource} should be updated.`,
    options: { A: 'whether', B: 'which', C: 'where', D: 'whose' },
    answer: 'A',
    explanation: 'whether 引导宾语从句，表示“是否”。',
  },
  {
  ...
  {
    slug: 'whoever-subject-clause',
    focus: '名词性从句|whoever',
    prompt: (context) => `___ finishes the ${context.artifact} first should check it again.`,
    options: { A: 'Whoever', B: 'Whom', C: 'Which', D: 'Where' },
    answer: 'A',
    explanation: 'whoever 引导主语从句，表示“无论谁”。',
  },
  {
    slug: 'why-relative',
    focus: '定语从句|关系副词why',
    prompt: (context) => `The reason ___ ${context.learners} missed the clue was discussed later.`,
    options: { A: 'why', B: 'which', C: 'who', D: 'whose' },
    answer: 'A',
    explanation: '先行词 reason 后用 why 引导定语从句并作原因状语。',
  },
  {
    slug: 'when-relative',
    focus: '定语从句|关系副词when',
    prompt: (context) => `The day ___ ${context.futureEvent} takes place is marked on the calendar.`,
    options: { A: 'which', B: 'when', C: 'who', D: 'where' },
    answer: 'B',
    explanation: '先行词 day 表示时间，从句缺时间状语，用 when。',
  },
  {
    slug: 'whose-relative',
    focus: '定语从句|whose',
    prompt: (context) => `The learner ___ ${context.artifact} was selected gave a short speech.`,
    options: { A: 'who', B: 'whose', C: 'which', D: 'where' },
    answer: 'B',
    explanation: 'whose 表示所属关系，修饰 artifact。',
  },
  {
    slug: 'what-subject-clause',
    focus: '名词性从句|what',
    prompt: (context) => `___ matters most in ${context.topic} is whether the answer matches the evidence.`,
    options: { A: 'What', B: 'That', C: 'Which', D: 'Where' },
    answer: 'A',
    explanation: 'what 引导主语从句，并在从句中作主语。',
  },
  {
    slug: 'as-if-clause',
    focus: '状语从句|as if',
    prompt: (context) => `${capitalizeFirst(context.learner)} explained the rule as if he ___ the whole chapter.`,
    options: { A: 'reads', B: 'has read', C: 'had read', D: 'will read' },
    answer: 'C',
    explanation: 'as if 后表示与过去事实相反的情况，可用 had done。',
  },
  {
    slug: 'while-contrast',
    focus: '状语从句|while',
    prompt: (context) => `Some answers about ${context.topic} looked similar, ___ only one matched the sentence structure.`,
    options: { A: 'while', B: 'because of', C: 'unless', D: 'so that' },
    answer: 'A',
    explanation: 'while 可表示对比关系，意为“然而”。',
  },
  {
    slug: 'as-long-as-condition',
    focus: '条件状语从句|as long as',
    prompt: (context) => `The ${context.resource} can be borrowed ___ it is returned before Friday.`,
    options: { A: 'as long as', B: 'even though', C: 'as if', D: 'so that' },
    answer: 'A',
    explanation: 'as long as 表示“只要”，引导条件状语从句。',
  },
  {
    slug: 'provided-that',
    focus: '条件状语从句|provided that',
    prompt: (context) => `${capitalizeFirst(context.learners)} may change the topic, ___ they explain the reason clearly.`,
    options: { A: 'provided that', B: 'even if', C: 'as though', D: 'because of' },
    answer: 'A',
    explanation: 'provided that 表示“只要、如果”，引导条件状语从句。',
  },
  {
    slug: 'whereas-contrast',
    focus: '状语从句|whereas',
    prompt: (context) => `${capitalizeFirst(context.learner)} focused on meaning, ___ the coach focused on sentence form.`,
    options: { A: 'whereas', B: 'unless', C: 'so that', D: 'because of' },
    answer: 'A',
    explanation: 'whereas 表示对比关系，意为“然而、而”。',
  },
  {
    slug: 'even-if-concession',
    focus: '让步状语从句|even if',
    prompt: (context) => `${capitalizeFirst(context.learners)} should check the source ___ the answer seems obvious.`,
    options: { A: 'even if', B: 'because of', C: 'in order to', D: 'as soon as' },
    answer: 'A',
    explanation: 'even if 表示“即使”，引导让步状语从句。',
  },
  {
    slug: 'along-with-agreement',
    focus: '主谓一致|along with',
    prompt: (context) => `${capitalizeFirst(context.coach)}, along with two assistants, ___ preparing the ${context.resource}.`,
    options: { A: 'is', B: 'are', C: 'were', D: 'have' },
    answer: 'A',
    explanation: '主语是 coach，along with 短语不决定谓语单复数。',
  },
  {
    slug: 'as-well-as-agreement',
    focus: '主谓一致|as well as',
    prompt: (context) => `${capitalizeFirst(context.learner)}, as well as the other members, ___ ready for ${context.futureEvent}.`,
    options: { A: 'is', B: 'are', C: 'were', D: 'have' },
    answer: 'A',
    explanation: 'as well as 不改变真正主语 learner 的单数属性。',
  },
  {
    slug: 'neither-of-singular',
    focus: '主谓一致|neither of',
    prompt: (context) => `Neither of the two explanations in the ${context.resource} ___ supported by the example.`,
    options: { A: 'is', B: 'are', C: 'have', D: 'were' },
    answer: 'A',
    explanation: 'neither of 作主语时，正式用法中谓语常用单数。',
  },
  {
    slug: 'more-than-one-singular',
    focus: '主谓一致|more than one',
    prompt: (context) => `More than one ${context.artifact} ___ needed before ${context.futureEvent}.`,
    options: { A: 'is', B: 'are', C: 'have', D: 'were' },
    answer: 'A',
    explanation: 'more than one + 单数名词作主语时，谓语通常用单数。',
  },
  {
    slug: 'many-a-singular',
    focus: '主谓一致|many a',
    prompt: (context) => `Many a participant in ${context.event} ___ made the same mistake before.`,
    options: { A: 'has', B: 'have', C: 'are', D: 'were' },
    answer: 'A',
    explanation: 'many a + 单数名词作主语时，谓语用单数。',
  },
  {
    slug: 'none-of-plural',
    focus: '主谓一致|none of',
    prompt: (context) => `None of the ${context.pluralMistakes} ___ easy to explain without context.`,
    options: { A: 'is', B: 'are', C: 'has', D: 'be' },
    answer: 'B',
    explanation: 'none of + 复数名词指多个对象时，谓语可用复数。',
  },
  {
    slug: 'one-of-plural-relative',
    focus: '主谓一致|one of复数先行词',
    prompt: (context) => `${capitalizeFirst(context.learner)} is one of the members who ___ every meeting.`,
    options: { A: 'attend', B: 'attends', C: 'attending', D: 'has attended' },
    answer: 'A',
    explanation: 'who 指代复数 members，定语从句谓语用复数。',
  },
  {
    slug: 'the-only-one-singular-relative',
    focus: '主谓一致|the only one',
    prompt: (context) => `${capitalizeFirst(context.learner)} is the only one of the members who ___ the rule clearly.`,
    options: { A: 'understand', B: 'understands', C: 'understanding', D: 'have understood' },
    answer: 'B',
    explanation: 'the only one 强调单数先行词，定语从句谓语用单数。',
  },
  {
    slug: 'between-two',
    focus: '介词搭配|between',
    prompt: (context) => `${capitalizeFirst(context.learner)} had to choose ___ the two possible answers.`,
    options: { A: 'among', B: 'between', C: 'during', D: 'with' },
    answer: 'B',
    explanation: 'between 用于两者之间的选择。',
  },
  {
    slug: 'among-many',
    focus: '介词搭配|among',
    prompt: (context) => `The best example in the ${context.resource} was hidden ___ several similar sentences.`,
    options: { A: 'between', B: 'among', C: 'with', D: 'by' },
    answer: 'B',
    explanation: 'among 用于三者或三者以上之间。',
  },
  {
    slug: 'during-event',
    focus: '介词短语|during',
    prompt: (context) => `${capitalizeFirst(context.learners)} asked several questions ___ ${context.event}.`,
    options: { A: 'during', B: 'since', C: 'for', D: 'until' },
    answer: 'A',
    explanation: 'during 后接一段事件或活动，表示“在……期间”。',
  },
  {
    slug: 'since-point-time',
    focus: '介词短语|since',
    prompt: (context) => `${capitalizeFirst(context.learner)} has kept a review log ___ last September.`,
    options: { A: 'for', B: 'since', C: 'during', D: 'by' },
    answer: 'B',
    explanation: 'since 后接过去时间点，常与现在完成时连用。',
  },
  {
    slug: 'for-period-time',
    focus: '介词短语|for',
    prompt: (context) => `${capitalizeFirst(context.learners)} have discussed the ${context.artifact} ___ half an hour.`,
    options: { A: 'since', B: 'for', C: 'during', D: 'until' },
    answer: 'B',
    explanation: 'for 后接一段时间，表示持续多久。',
  },
  {
    slug: 'instead-of-doing',
    focus: '介词短语|instead of doing',
    prompt: (context) => `${capitalizeFirst(context.learners)} checked the rule instead of ___ from memory.`,
    options: { A: 'guess', B: 'to guess', C: 'guessing', D: 'guessed' },
    answer: 'C',
    explanation: 'instead of 后接名词或动名词。',
  },
  {
    slug: 'due-to-noun',
    focus: '介词短语|due to',
    prompt: (context) => `${capitalizeFirst(context.event)} was delayed due ___ ${context.reason}.`,
    options: { A: 'to', B: 'for', C: 'with', D: 'by' },
    answer: 'A',
    explanation: 'due to 后接名词短语，表示原因。',
  },
  {
    slug: 'in-charge-of',
  ...
  {
    slug: 'similar-to',
    focus: '形容词搭配|similar to',
    prompt: (context) => `The new question was similar ___ the example in the ${context.resource}.`,
    options: { A: 'with', B: 'to', C: 'as', D: 'from' },
    answer: 'B',
    explanation: 'similar to 是固定搭配。',
  },
  {
    slug: 'familiar-with',
    focus: '形容词搭配|familiar with',
    prompt: (context) => `${capitalizeFirst(context.learners)} became familiar ___ the format after practice.`,
  ...
  {
    slug: 'inferior-to',
    focus: '比较结构|inferior to',
    prompt: (context) => `The first ${context.artifact} was inferior ___ the revised version.`,
    options: { A: 'than', B: 'to', C: 'from', D: 'as' },
    answer: 'B',
    explanation: 'inferior to 表示“比……差”，不用 than。',
  },
  {
    slug: 'rather-than',
    focus: '并列结构|rather than',
    prompt: (context) => `${capitalizeFirst(context.learners)} should compare evidence ___ rely on a single keyword.`,
    options: { A: 'rather than', B: 'because of', C: 'as soon as', D: 'in case' },
    answer: 'A',
    explanation: 'rather than 连接并列成分，表示“而不是”。',
  },
  {
    slug: 'not-but',
    focus: '并列结构|not...but',
    prompt: (context) => `The problem in the ${context.artifact} was not the topic ___ the sentence structure.`,
    options: { A: 'and', B: 'but', C: 'or', D: 'nor' },
    answer: 'B',
    explanation: 'not...but... 表示“不是……而是……”。',
  },
  {
    slug: 'not-so-much-as',
    focus: '并列结构|not so much...as',
    prompt: (context) => `The ${context.topic} task is not so much about speed ___ about accuracy.`,
    options: { A: 'as', B: 'than', C: 'but', D: 'or' },
    answer: 'A',
    explanation: 'not so much A as B 表示“与其说是 A，不如说是 B”。',
  },
  {
    slug: 'had-it-not-been-for',
    focus: '虚拟语气|省略if倒装',
    prompt: (context) => `Had it not been for ${context.coach}, ${context.learners} ___ the deadline.`,
    options: { A: 'miss', B: 'missed', C: 'would have missed', D: 'will miss' },
    answer: 'C',
    explanation: 'Had it not been for... 是省略 if 的虚拟倒装，主句用 would have done。',
  },
  {
    slug: 'were-it-not-for',
    focus: '虚拟语气|were倒装',
    prompt: (context) => `Were it not for the ${context.resource}, ${context.learners} ___ confused.`,
    options: { A: 'will be', B: 'would be', C: 'are', D: 'were' },
    answer: 'B',
    explanation: 'Were it not for... 表示与现在事实相反，主句用 would do。',
  },
  {
  ...
  {
    slug: 'not-only-did',
    focus: '倒装结构|not only句首',
    prompt: (context) => `Not only ___ ${context.learner} finish the ${context.artifact}, but he also explained it clearly.`,
    options: { A: 'did', B: 'does', C: 'has', D: 'is' },
    answer: 'A',
    explanation: 'not only 位于句首时，前半句用部分倒装。',
  },
  {
    slug: 'nor-did',
    focus: '倒装结构|nor',
    prompt: (context) => `${capitalizeFirst(context.learner)} did not guess the answer, nor ___ he copy it from others.`,
    options: { A: 'did', B: 'does', C: 'was', D: 'has' },
    answer: 'A',
    explanation: 'nor 放在分句开头表示“也不”，后面用部分倒装。',
  },
  {
    slug: 'so-clear-was',
    focus: '倒装结构|so...that句首',
    prompt: (context) => `So clear ___ the ${context.resource} explanation that everyone understood the rule.`,
    options: { A: 'was', B: 'were', C: 'is being', D: 'has been' },
    answer: 'A',
    explanation: 'so + 形容词位于句首时，主句可用部分倒装。',
  },
  {
    slug: 'it-is-time',
    focus: '虚拟语气|It is time',
    prompt: (context) => `It is time ${context.learners} ___ the answer without hints.`,
    options: { A: 'check', B: 'checked', C: 'will check', D: 'checking' },
    answer: 'B',
    explanation: 'It is time + 从句常用过去式表示“该做某事了”。',
  },
  {
    slug: 'wish-past',
    focus: '虚拟语气|wish从句',
    prompt: (context) => `${capitalizeFirst(context.learner)} wishes he ___ more time to revise the ${context.artifact}.`,
    options: { A: 'has', B: 'had', C: 'will have', D: 'has had' },
    answer: 'B',
    explanation: 'wish 后表示与现在事实相反的愿望，从句用过去式。',
  },
  {
    slug: 'if-only-past-perfect',
    focus: '虚拟语气|if only',
    prompt: (context) => `If only ${context.learner} ___ the instructions earlier.`,
    options: { A: 'reads', B: 'read', C: 'had read', D: 'will read' },
    answer: 'C',
    explanation: 'if only 表示对过去的遗憾时，用 had done。',
  },
  {
    slug: 'it-is-no-use-doing',
    focus: '固定句型|It is no use doing',
    prompt: (context) => `It is no use ___ the ${context.topic} answer without reading the whole sentence.`,
    options: { A: 'guess', B: 'to guess', C: 'guessing', D: 'guessed' },
    answer: 'C',
    explanation: 'It is no use doing sth. 表示“做某事没有用”。',
  },
  {
    slug: 'it-is-said-that',
    focus: '固定句型|It is said that',
    prompt: (context) => `It is said ___ the ${context.resource} will be available tomorrow.`,
    options: { A: 'what', B: 'that', C: 'which', D: 'where' },
    answer: 'B',
    explanation: 'It is said that... 是固定句型，that 引导主语从句后置。',
  },
  {
    slug: 'make-sense-to',
    focus: '固定搭配|make sense to',
    prompt: (context) => `The example in the ${context.resource} made sense ___ ${lowerFirst(context.learners)}.`,
    options: { A: 'to', B: 'for', C: 'with', D: 'about' },
    answer: 'A',
    explanation: 'make sense to sb. 表示“对某人来说有意义/能理解”。',
  },
  {
    slug: 'take-part-in',
    focus: '固定搭配|take part in',
    prompt: (context) => `${capitalizeFirst(context.learners)} decided to take part ___ ${context.event}.`,
    options: { A: 'in', B: 'on', C: 'at', D: 'with' },
    answer: 'A',
    explanation: 'take part in 表示“参加”。',
  },
  {
    slug: 'pay-attention-to-doing',
    focus: '固定搭配|pay attention to doing',
    prompt: (context) => `${capitalizeFirst(context.learners)} should pay attention to ___ the verb form.`,
    options: { A: 'check', B: 'checking', C: 'to check', D: 'checked' },
    answer: 'B',
    explanation: 'pay attention to 中 to 是介词，后接动名词。',
  },
  {
    slug: 'object-to-doing',
    focus: '固定搭配|object to doing',
    prompt: (context) => `${capitalizeFirst(context.learners)} objected to ___ the topic at the last minute.`,
    options: { A: 'change', B: 'changing', C: 'to change', D: 'changed' },
    answer: 'B',
    explanation: 'object to doing sth. 表示“反对做某事”。',
  },
  {
    slug: 'be-devoted-to',
    focus: '固定搭配|be devoted to',
    prompt: (context) => `${capitalizeFirst(context.coach)} is devoted ___ helping ${lowerFirst(context.learners)} improve.`,
    options: { A: 'to', B: 'for', C: 'with', D: 'at' },
    answer: 'A',
    explanation: 'be devoted to doing sth. 中 to 是介词。',
  },
  {
    slug: 'hardly-when',
  ...
  {
    slug: 'scarcely-when',
    focus: '倒装结构|scarcely...when',
    prompt: (context) => `Scarcely ___ ${context.learners} opened the ${context.resource} when they found the clue.`,
    options: { A: 'had', B: 'did', C: 'have', D: 'will' },
    answer: 'A',
    explanation: 'scarcely 位于句首时用部分倒装，常与 when 搭配。',
  },
  {
    slug: 'little-did-know',
    focus: '倒装结构|little',
    prompt: (context) => `Little ___ ${context.learner} know that the answer was hidden in the previous sentence.`,
    options: { A: 'did', B: 'does', C: 'was', D: 'has' },
    answer: 'A',
    explanation: '否定意义副词 little 位于句首时，主句用部分倒装。',
  },
  {
    slug: 'so-neither-response',
    focus: '倒装结构|neither do I',
    prompt: (context) => `${capitalizeFirst(context.learner)} does not rely on guessing, and neither ___ the coach.`,
    options: { A: 'does', B: 'do', C: 'is', D: 'has' },
    answer: 'A',
    explanation: 'neither + 助动词 + 主语表示“……也不”，coach 是单数，用 does。',
  },
  {
    slug: 'another-other',
    focus: '代词|another',
    prompt: (context) => `This ${context.artifact} example is unclear; please give ___ one.`,
    options: { A: 'another', B: 'other', C: 'the other', D: 'others' },
    answer: 'A',
    explanation: 'another one 表示“另一个”。',
  },
  {
    slug: 'the-other-two',
    focus: '代词|the other',
    prompt: (context) => `Of the two ${context.topic} answers, one is grammatical and ___ is not.`,
    options: { A: 'another', B: 'other', C: 'the other', D: 'others' },
    answer: 'C',
    explanation: '两者中的另一个用 the other。',
  },
  {
    slug: 'few-little',
    focus: '数量词|few与little',
    prompt: (context) => `There is ___ time left, so ${lowerFirst(context.learners)} must decide quickly.`,
    options: { A: 'few', B: 'little', C: 'many', D: 'several' },
    answer: 'B',
    explanation: 'time 是不可数名词，表示“几乎没有”用 little。',
  },
  {
    slug: 'a-few-positive',
    focus: '数量词|a few',
    prompt: (context) => `${capitalizeFirst(context.learners)} found ___ useful clues in the final paragraph.`,
    options: { A: 'a few', B: 'a little', C: 'much', D: 'less' },
    answer: 'A',
    explanation: 'clues 是可数名词复数，表示“一些”用 a few。',
  },
  {
    slug: 'a-little-positive',
    focus: '数量词|a little',
    prompt: (context) => `${capitalizeFirst(context.learner)} needed ___ more time to check the answer.`,
    options: { A: 'a few', B: 'a little', C: 'many', D: 'several' },
    answer: 'B',
    explanation: 'time 是不可数名词，表示“一点儿”用 a little。',
  },
  {
    slug: 'larger-number-than',
    focus: '比较结构|比较级than',
    prompt: (context) => `The revised ${context.artifact} contains ___ examples than the first version.`,
    options: { A: 'more', B: 'much', C: 'most', D: 'many' },
    answer: 'A',
    explanation: 'than 前使用比较级 more。',
  },
  {
    slug: 'less-uncountable-than',
    focus: '数量词|less不可数',
    prompt: (context) => `The second ${context.artifact} caused ___ confusion than the first one.`,
    options: { A: 'fewer', B: 'less', C: 'many', D: 'few' },
    answer: 'B',
    explanation: 'confusion 是不可数名词，比较“更少”用 less。',
  },
  {
    slug: 'most-of-plural',
    focus: '代词|most of',
    prompt: (context) => `Most of the ${context.pluralMistakes} ___ corrected after feedback.`,
    options: { A: 'was', B: 'were', C: 'has', D: 'is' },
    answer: 'B',
    explanation: 'most of + 复数名词作主语时，谓语用复数。',
  },
  {
    slug: 'neither-nor-choice',
    focus: '并列结构|neither...nor',
    prompt: (context) => `The final ${context.topic} answer was neither copied ___ guessed.`,
  ...
  {
    slug: 'whether-to-do',
    focus: '非谓语|whether to do',
    prompt: (context) => `${capitalizeFirst(context.learner)} was not sure whether ___ the ${context.artifact} tonight.`,
    options: { A: 'revise', B: 'to revise', C: 'revising', D: 'revised' },
    answer: 'B',
    explanation: 'whether to do 可作宾语，表示“是否去做”。',
  },
  {
    slug: 'question-word-to-do',
    focus: '非谓语|疑问词to do',
    prompt: (context) => `${capitalizeFirst(context.learners)} learned how ___ the key words quickly.`,
    options: { A: 'locate', B: 'to locate', C: 'locating', D: 'located' },
    answer: 'B',
    explanation: '疑问词 how 后可接不定式作宾语。',
  },
  {
    slug: 'too-adjective-for-to',
    focus: '比较结构|too...for sb to do',
    prompt: (context) => `The instruction was too vague for ${lowerFirst(context.learners)} ___ correctly.`,
    options: { A: 'follow', B: 'to follow', C: 'following', D: 'followed' },
    answer: 'B',
    explanation: 'too + 形容词 + for sb. + to do 表示“太……以至于某人不能……”。',
  },
  {
    slug: 'so-that-can',
  ...
  {
    slug: 'until-not',
    focus: '时间状语从句|not until',
    prompt: (context) => `${capitalizeFirst(context.learner)} did not notice the error ___ the teacher pointed it out.`,
    options: { A: 'until', B: 'since', C: 'during', D: 'for' },
    answer: 'A',
    explanation: 'not...until... 表示“直到……才……”。',
  },
  {
    slug: 'hard-to-believe',
    focus: '固定句型|主语be形容词to do',
    prompt: (context) => `The ${context.topic} result was hard ___ at first.`,
    options: { A: 'believe', B: 'to believe', C: 'believing', D: 'believed' },
    answer: 'B',
    explanation: '主语 + be + 形容词 + to do 是常见结构。',
  },
  {
    slug: 'easy-for-to',
    focus: '固定句型|It is adj for sb to do',
    prompt: (context) => `It was easy for ${lowerFirst(context.learners)} ___ the wrong option.`,
    options: { A: 'remove', B: 'to remove', C: 'removing', D: 'removed' },
    answer: 'B',
    explanation: 'It is/was + 形容词 + for sb. + to do 是固定句型。',
  },
  {
    slug: 'kind-of-to',
    focus: '固定句型|It is adj of sb to do',
    prompt: (context) => `It was careful of ${context.learner} ___ the source before answering.`,
    options: { A: 'check', B: 'to check', C: 'checking', D: 'checked' },
    answer: 'B',
    explanation: '评价人的品质时可用 It is + adj. + of sb. + to do。',
  },
  {
    slug: 'the-same-as',
    focus: '比较结构|the same as',
    prompt: (context) => `The second ${context.artifact} was not the same ___ the first one.`,
    options: { A: 'as', B: 'than', C: 'to', D: 'from' },
    answer: 'A',
    explanation: 'the same as 表示“与……相同”。',
  },
  {
    slug: 'different-from-comparison',
    focus: '形容词搭配|different from',
    prompt: (context) => `The ${context.topic} rule in this sentence is different ___ the one in the example.`,
    options: { A: 'from', B: 'than', C: 'as', D: 'with' },
    answer: 'A',
    explanation: 'different from 是标准搭配。',
  },
  {
    slug: 'be-known-for',
    focus: '介词搭配|be known for',
    prompt: (context) => `${capitalizeFirst(context.coach)} is known ___ clear explanations.`,
    options: { A: 'as', B: 'for', C: 'to', D: 'with' },
    answer: 'B',
    explanation: 'be known for 表示“因……而出名”。',
  },
  {
    slug: 'be-known-as',
    focus: '介词搭配|be known as',
    prompt: (context) => `${capitalizeFirst(context.learner)} is known ___ a careful reviewer in the group.`,
    options: { A: 'for', B: 'as', C: 'to', D: 'with' },
    answer: 'B',
    explanation: 'be known as 表示“作为……而出名”。',
  },
  {
    slug: 'be-made-of',
  ...
  {
    slug: 'be-made-from',
    focus: '介词搭配|be made from',
    prompt: (context) => `The model for ${context.event} was made ___ old plastic bottles.`,
    options: { A: 'of', B: 'from', C: 'by', D: 'with' },
    answer: 'B',
    explanation: 'be made from 表示原材料经过变化后制成。',
  },
  {
    slug: 'as-a-result-of',
    focus: '介词短语|as a result of',
    prompt: (context) => `${capitalizeFirst(context.event)} changed as a result ___ ${context.reason}.`,
    options: { A: 'of', B: 'for', C: 'to', D: 'with' },
    answer: 'A',
    explanation: 'as a result of 后接名词短语，表示原因。',
  },
  {
    slug: 'in-addition-to-doing',
    focus: '介词短语|in addition to doing',
    prompt: (context) => `In addition to ___ the rule, ${context.learners} compared two examples.`,
    options: { A: 'review', B: 'reviewing', C: 'to review', D: 'reviewed' },
    answer: 'B',
    explanation: 'in addition to 中 to 是介词，后接动名词。',
  },
  {
    slug: 'be-about-to',
    focus: '时态|be about to',
    prompt: (context) => `${capitalizeFirst(context.learner)} was about ___ the answer when the bell rang.`,
    options: { A: 'submit', B: 'to submit', C: 'submitting', D: 'submitted' },
    answer: 'B',
    explanation: 'be about to do 表示“正要做某事”。',
  },
  {
    slug: 'used-to-vs-would',
    focus: '时态|used to',
    prompt: (context) => `${capitalizeFirst(context.learner)} ___ confuse these two structures, but now he can tell them apart.`,
    options: { A: 'used to', B: 'would to', C: 'was used to', D: 'is used to' },
    answer: 'A',
    explanation: 'used to do 表示过去常常做而现在不再如此。',
  },
  {
    slug: 'have-been-to',
    focus: '时态|have been to',
    prompt: (context) => `${capitalizeFirst(context.learner)} has ___ to the language lab twice this month.`,
    options: { A: 'gone', B: 'been', C: 'went', D: 'go' },
    answer: 'B',
    explanation: 'have been to 表示“去过某地”，人已回来。',
  },
  {
    slug: 'have-gone-to',
    focus: '时态|have gone to',
    prompt: (context) => `${capitalizeFirst(context.coach)} is not here; he has ___ to the office.`,
    options: { A: 'been', B: 'gone', C: 'went', D: 'go' },
    answer: 'B',
    explanation: 'have gone to 表示“已经去了某地”，人尚未回来。',
  },
  {
    slug: 'can-not-too',
    focus: '固定结构|cannot...too',
    prompt: (context) => `${capitalizeFirst(context.learners)} cannot be too ___ when they check the ${context.artifact}.`,
    options: { A: 'careful', B: 'carefully', C: 'careless', D: 'care' },
    answer: 'A',
    explanation: 'cannot be too + 形容词表示“再……也不为过”。',
  },
  {
    slug: 'anything-but',
    focus: '固定结构|anything but',
    prompt: (context) => `The final ${context.artifact} was anything ___ simple.`,
    options: { A: 'but', B: 'and', C: 'or', D: 'nor' },
    answer: 'A',
    explanation: 'anything but 表示“绝不、根本不”。',
  },
  {
    slug: 'nothing-but',
    focus: '固定结构|nothing but',
    prompt: (context) => `The explanation in the ${context.resource} contained nothing ___ evidence from the sentence.`,
    options: { A: 'but', B: 'and', C: 'or', D: 'nor' },
    answer: 'A',
    explanation: 'nothing but 表示“只有、仅仅”。',
  },
  {
    slug: 'all-but',
    focus: '固定结构|all but',
    prompt: (context) => `The difficult clue in the ${context.artifact} was all ___ impossible to notice at first.`,
    options: { A: 'but', B: 'and', C: 'or', D: 'nor' },
    answer: 'A',
    explanation: 'all but 可表示“几乎”。',
  },
  {
    slug: 'be-to-blame',
    focus: '固定结构|be to blame',
    prompt: (context) => `The unclear ${context.resource} was to ___ for the mistake.`,
    options: { A: 'blame', B: 'be blamed', C: 'blaming', D: 'blamed' },
    answer: 'A',
    explanation: 'be to blame 主动形式表达被动意义，表示“应受责备”。',
  },
];

const GRAMMAR_STRUCTURE_FRAMES: readonly GrammarStructureFrame[] = [
  ...BASE_GRAMMAR_STRUCTURE_FRAMES,
  ...SUPPLEMENTAL_GRAMMAR_STRUCTURE_FRAMES,
];
...
function buildGrammarStructureCombinations(): Array<{
  frame: GrammarStructureFrame;
  prompt: string;
  context: GrammarStructureContext;
}> {
  const targetGeneratedCount = GRAMMAR_STRUCTURE_TARGET_COUNT - CET4_CORE_GRAMMAR_STRUCTURE_ROWS.length;
  ...
  for (let round = 0; combinations.length < targetGeneratedCount; round += 1) {
    for (let frameIndex = 0; frameIndex < GRAMMAR_STRUCTURE_FRAMES.length
      && combinations.length < targetGeneratedCount; frameIndex += 1) {
      const frame = GRAMMAR_STRUCTURE_FRAMES[frameIndex];
      const context = GRAMMAR_STRUCTURE_CONTEXTS[(frameIndex + round) % GRAMMAR_STRUCTURE_CONTEXTS.length];
      combinations.push({
        frame,
        prompt: frame.prompt(context),
        context,
      });
    }
  }
...
const GENERATED_GRAMMAR_STRUCTURE_ROWS: GrammarStructureRow[] = buildGrammarStructureCombinations()
  .map(({ frame, prompt, context }, index) => {
    ...
    return [
      ...
      `${frame.focus}|${frame.slug}|${context.topic}`,
    ];
  });
